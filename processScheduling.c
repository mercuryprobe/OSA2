...
void processA() {
    ...
    if (pid==0) {
        ...
        char *arr1[48] = {"cd", "~/kernelbuild/linux-5.19.81/linux-5.19.8"};
        char *arr7[8] = {"pwd"};
        char *arr2[16] = {"make", "mrproper"};
        char *arr3[8] = {"cd", ".."};
        char *arr4[48] = {"cp", ".config", "linux-5.19.81/linux-5.19.8"};
        char *arr5[48] = {"cd", "linux-5.19.81/linux-5.19.8"};
        char *arr6[8] = {"make"};
        execvp("/bin/cd", arr1);
        execvp("/bin/pwd", arr7);
